<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Clientdashboard.aspx.cs" Inherits="Healthy_U.Clientdashboardaspx" %>
...
<body>
			...
			<div class="container">
               ...
               <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"><span class="fa fa-user" style="font-size: 30px;"></span></a>
                   ...
                   <a href="userlogout.aspx" class="dropdown-item">Logout</a> 
                        <a href="client_change_password.aspx" class="dropdown-item">change your password</a>
	...
	<asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/contact1.aspx">Contactus</asp:HyperLink>
