    ...
    public partial class cds : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (ds.Tables.Count > 0 && ds.Tables["UserRegistration"].Rows.Count > 0)
            {
                ...
                lbl_phone.Text = ds.Tables["UserRegistration"].Rows[0][2].ToString();
                lbl_email.Text = ds.Tables["UserRegistration"].Rows[0][3].ToString();
                lbl_height.Text = ds.Tables["UserRegistration"].Rows[0][4].ToString();
                lbl_weight.Text = ds.Tables["UserRegistration"].Rows[0][5].ToString();
                lbl_age.Text = ds.Tables["UserRegistration"].Rows[0][6].ToString();
                lbl_disease.Text = ds.Tables["UserRegistration"].Rows[0][7].ToString();
                lbl_medi.Text = ds.Tables["UserRegistration"].Rows[0][8].ToString();
            }
        }
