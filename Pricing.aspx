<%@ Page Title="" Language="C#" MasterPageFile="~/GuestMaster.Master" AutoEventWireup="true" CodeFile="Pricing.aspx.cs" Inherits="Healthy_U.Pricing" %>
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-3 p-0">
                <div class="card card-pricing text-center px-3 mb-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <asp:Button ID="Button2" runat="server" Text="Join Now" CssClass="form-control rounded-pill" BackColor="#400082" ForeColor="White" />
                    </div>
                </div>
            </div>
