<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminForgotPassword.aspx.cs" Inherits="Healthy_U.AdminForgotPassword" %>
...
<body>
    ...
    <div class="container shadow-sm p-3 mb-5 bg-body rounded"">
         <h2 style="text-align:center; margin-bottom:20px; margin-top:20px;">FORGOT PASSWORD</h2>
    <div class="row">
       <div class="col-auto">
           <p style="font-size:20px; font-style:normal;">Lost your password? Please enter your EmailId,  You will receive your current login details via registered email.</p>
    <label for="text" class="col-form-label">Please enter your Registered Email:</label>
      <asp:TextBox ID="txtEmail" runat="server" Class="form-control-lg" ></asp:TextBox>
        </div>
        </div>
    <div class="row">
        <div class="col mt-2 mb-4">
        <asp:Button ID="btnSend" runat="server" Text="Send Email"  Class="form-control-sm mt-2 btn-primary" OnClick="btnSend_Click" />
